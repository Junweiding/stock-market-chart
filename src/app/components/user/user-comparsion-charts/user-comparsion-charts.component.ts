...
@Component({
  selector: 'app-user-comparsion-charts',
  templateUrl: './user-comparsion-charts.component.html',
  styleUrls: ['./user-comparsion-charts.component.css']
})
export class UserComparsionChartsComponent implements OnInit {
